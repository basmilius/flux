            ...
            <ApiComponent name="Stack">
                <template #props>
                    ...
                    <tr>
                        ...
                        <td>When provided, the stack fills its parent.</td>
                    </tr>
                    <tr>
                        <td><code>is-growing</code><code>boolean</code></td>
                        <td>When provided, the stack elements grow based on the stack's width.</td>
                    </tr>
                    <tr>

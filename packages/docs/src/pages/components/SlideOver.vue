<template>
    <flux-stack>
        ...
        <api-section>
            <p>
                A slide over is a modal-like interface that slides in from the side of the view to display
                additional content or options. It typically allows users to easily access important information
                without disrupting their current workflow. Slide overs are mostly used to reveal opions for
                an entity.
            </p>
        </api-section>
            ...
            <api-component name="SlideOver">
                <template #slots>
                    <tr>
                        ...
                        <td>Content of the slide over.</td>
                    </tr>
                </template>
            </api-component>
        </api-section>
        ...
        <api-section title="Examples">
            <api-example
                ...
                :component="basic"
                title="Basic"
                description="A basic slide over with some content."/>

            <api-example
                :code="tabsCode"
                :component="tabs"
                title="Tabs"
                description="A slide over with tabs."/>
        </api-section>
    </flux-stack>
</template>
...
<script
    ...
    import basic from '@/code/components/slide-over/basic.vue';
    import basicCode from '@/code/components/slide-over/basic.vue?raw';
    import tabs from '@/code/components/slide-over/tabs.vue';
    import tabsCode from '@/code/components/slide-over/tabs.vue?raw';

    ...
    <FluxStack>
        ...
        <Preview>
            <FluxPane style="width: 60%">
                ...
                <FluxPaneFooter>
                    <FluxSecondaryButton label="Back"/>
        ...
        <ApiSection title="API">
            ...
            <ApiComponent name="FormInputAddition">
                <template #props>
                    <tr>
            ...
            <ApiComponent name="FormInputGroup">
                <template #slots>
                    <tr>
                        <td><code>default</code><code>{}</code></td>

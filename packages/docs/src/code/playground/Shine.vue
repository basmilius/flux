<template>
    <FluxStack>
        ...
        <FluxBorderShine
            :colors="['transparent', '#06b6d4', 'transparent']"
            :duration="2"
            :offset="4"
            radius="calc(var(--radius) + 3px)"
            :width="2">
...
<script
    lang="ts"
    setup>
    import { FluxBorderShine, FluxPane, FluxPrimaryButton, FluxSecondaryButton, FluxStack } from '@basmilius/flux';
    import { FluxPaneBody, FluxPaneHeader, FluxPaneIllustration } from '@basmilius/flux';
</script>

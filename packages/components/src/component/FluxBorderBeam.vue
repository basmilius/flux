...
<script
    ...
    import { useBorderBeamPulse, type BorderBeamVariant } from '~flux/components/composable/private';
    import $style from '~flux/components/css/component/BorderBeam.module.scss';

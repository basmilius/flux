    ...
    <div
        ...
        <flux-fade-transition>
            <dialog
                ...
                open>
                <flux-menu>
                    <template v-for="([item, subItems], index) of groupedOptions">
                        <flux-menu-group
                            v-if="!item || isFluxFormSelectGroup(item)"
                            :key="`group-${index}`">
                        ...
                        <flux-menu-item
                            v-else-if="isFluxFormSelectOption(item)"
                            ref="optionRefs"
                            :key="`item-${index}`"
                            :icon-before="item.icon"
...
<script
    ...
    const groupedOptions = computed(() => {
        const groups: ([FluxFormSelectGroup | FluxFormSelectOption | null, FluxFormSelectOption[]])[] = [];

...
<script
    ...
    import { buildSharedPieTooltipOptions, CHART_DEFAULT_COLORS, DONUT_SERIES_DEFAULTS, POLAR_BASE_OPTIONS } from '~flux/statistics/util';
    ...
    const decoratedSeries = computed<PieSeriesOption[]>(() =>
        series.map(item => ({ ...DONUT_SERIES_DEFAULTS, ...item }))
    );

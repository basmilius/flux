...
describe('table primitives', () => {
    ...
    it('inherits column formatting from declarative headers', () => {
        ...
        expect(header.className).toMatch(/isNoWrap/);
    ...
    it('keeps the active row while the table context updates', () => {
        render(
            <FluxTable>
                <FluxTableRow isClickable><FluxTableCell>Alpha</FluxTableCell></FluxTableRow>
                <FluxTableRow isClickable><FluxTableCell>Beta</FluxTableCell></FluxTableRow>
            </FluxTable>
        );

...
::: render
render=../../code/visuals/border-beam/preview.vue
:::
...
example=../../code/visuals/border-beam/pulse.vue
:::

::: example Palettes || Four color palettes are available: colorful, mono, ocean and sunset.
example=../../code/visuals/border-beam/palettes.vue
:::

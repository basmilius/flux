...
::: render
render=../../code/components/expandable/group/preview.vue
:::
...
example=../../code/components/expandable/group/default.vue
:::

::: example Pane || Grouped expandables are especially nice within a Pane.
example=../../code/components/expandable/group/pane.vue
:::

...
::: render
render=../../code/components/expandable/preview.vue
:::
...
example=../../code/components/expandable/basic.vue
:::

::: example Pane || Expandables work great with panes.
example=../../code/components/expandable/pane.vue
:::
...
example=../../code/components/expandable/custom.vue
:::

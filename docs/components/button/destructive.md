...
::: render
render=../../code/components/button/destructive/preview.vue
:::
...
::: example Basic || A basic destructive button with a label.
example=../../code/components/button/destructive/basic.vue
:::

::: example Icon || A destructive button with an icon at the start or the end.
example=../../code/components/button/destructive/icon.vue
:::

::: example Sizes || The destructive button is available in four sizes.
example=../../code/components/button/destructive/sizes.vue
:::

::: example Active || Use is-active to keep the button in its pressed state, for example as a toggle.
example=../../code/components/button/destructive/active.vue
:::

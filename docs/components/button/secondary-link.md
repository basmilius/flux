...
::: render
render=../../code/components/button/secondary-link/preview.vue
:::
...
::: example Basic || A basic secondary link button with a label.
example=../../code/components/button/secondary-link/basic.vue
:::

::: example Icon || A secondary link button with an icon at the start or the end.
example=../../code/components/button/secondary-link/icon.vue
:::

::: example Sizes || The secondary link button is available in four sizes.
example=../../code/components/button/secondary-link/sizes.vue
:::

::: example Active || Use is-active to keep the button in its pressed state, for example as a toggle.
example=../../code/components/button/secondary-link/active.vue
:::

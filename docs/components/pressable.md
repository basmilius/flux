...
::: render
render=../code/components/pressable/preview.vue
:::
...
example=../code/components/pressable/route.vue
:::

::: example Link || Renders as an anchor tag for external links.
example=../code/components/pressable/link.vue
:::

::: example Button || Renders as a button element for click actions.
example=../code/components/pressable/button.vue
:::

...
::: render
render=../code/components/date-picker/preview.vue
:::
...
example=../code/components/date-picker/single.vue
:::

::: example Range || A date range can be selected here.
example=../code/components/date-picker/range.vue
:::

::: example Week || A week can be selected here.
example=../code/components/date-picker/week.vue
:::

::: example Month || A month can be selected here.
example=../code/components/date-picker/month.vue
:::

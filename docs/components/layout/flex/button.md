...
::: render
render=../../../code/components/layout/flex/button/preview.vue
:::
...
example=../../../code/components/layout/flex/button/horizontal.vue
:::

::: example Vertical || A vertical button stack.
example=../../../code/components/layout/flex/button/vertical.vue
:::

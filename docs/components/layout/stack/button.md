...
::: render
render=../../../code/components/layout/stack/button/preview.vue
:::
...
example=../../../code/components/layout/stack/button/horizontal.vue
:::

::: example Vertical || A vertical button stack.
example=../../../code/components/layout/stack/button/vertical.vue
:::

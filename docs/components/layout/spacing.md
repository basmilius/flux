...
::: render
render=../../code/components/layout/spacing/preview.vue
:::
...
example=../../code/components/layout/spacing/horizontal.vue
:::

::: example Vertical || A vertical spacing.
example=../../code/components/layout/spacing/vertical.vue
:::

...
emits:
    -   name: update:model-value
        description: Triggered when the selected date range changes.
        type:
...
::: render
render=../../code/components/form/date-range/preview.vue
:::

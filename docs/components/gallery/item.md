...
::: render
render=../../code/components/gallery/item/preview.vue
:::
...
example=../../code/components/gallery/item/basic.vue
:::

::: example Pending || A gallery item that is pending.
example=../../code/components/gallery/item/pending.vue
:::

::: example Delete || A gallery item that can be deleted.
example=../../code/components/gallery/item/delete.vue
:::

...
::: render
render=../../code/components/gallery/preview.vue
:::
...
example=../../code/components/gallery/basic.vue
:::

::: example Pending || A gallery with pending items
example=../../code/components/gallery/pending.vue
:::

::: example Edit || A gallery that can be edited.
example=../../code/components/gallery/edit.vue
:::

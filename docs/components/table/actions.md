...
slots:
    -   name: default
        description: The slot for the table actions.
---
...
::: render
render=../../code/components/table/actions/preview.vue
:::
...
::: example Basic || A basic table actions.
example=../../code/components/table/actions/basic.vue
:::

...
::: render
render=../../code/components/visual/animated-colors/preview.vue
:::
...
example=../../code/components/visual/animated-colors/free.vue
:::

::: example Pane || The animated colors visual can be used to make pane's more alive.
example=../../code/components/visual/animated-colors/pane.vue
:::

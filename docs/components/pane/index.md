...
::: render
render=../../code/components/pane/preview.vue
:::
...
example=../../code/components/pane/basic.vue
:::

::: example Loading || A pane with a loading state.
example=../../code/components/pane/loading.vue
:::

::: example Tag || A pane with a tag.
example=../../code/components/pane/tag.vue
:::

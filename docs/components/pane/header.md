...
::: render
render=../../code/components/pane/header/preview.vue
:::
...
example=../../code/components/pane/header/basic.vue
:::

::: example Icon || A pane header with an icon.
example=../../code/components/pane/header/icon.vue
:::

::: example Sub title || A pane header with an sub title.
example=../../code/components/pane/header/subtitle.vue
:::

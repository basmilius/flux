...
::: render
render=../../code/components/segmented-control/view/preview.vue
:::
...
example=../../code/components/segmented-control/view/basic.vue
:::

::: example Icons || A segmented control with icons only.
example=../../code/components/segmented-control/view/icon.vue
:::

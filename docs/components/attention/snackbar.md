...
::: render
render=../../code/components/attention/snackbar/functional.vue
:::
...
example=../../code/components/attention/snackbar/global.vue
:::

::: example Actions || Actions can be added to the snackbar to request for input.
example=../../code/components/attention/snackbar/actions.vue
:::

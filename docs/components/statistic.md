...
::: render
render=../code/components/statistic/preview.vue
:::
...
example=../code/components/statistic/basic.vue
:::

::: example Vertical || A vertical statistic.
example=../code/components/statistic/vertical.vue
:::

::: example Change || A statistic with change details.
example=../code/components/statistic/change.vue
:::

::: example Image || A statistic with an image.
example=../code/components/statistic/image.vue
:::

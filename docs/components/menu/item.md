...
props:
    ...
    -   name: image-alt
        description: An accessible label for the image.
        type: string
        optional: true
...
::: render
render=../../code/components/menu/item/preview.vue
:::
...
example=../../code/components/menu/item/basic.vue
:::

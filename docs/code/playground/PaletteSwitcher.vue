...
<script
    ...
    const PRIMARY_SCALES: readonly PaletteScale[] = [
        ...
        },
        {
            id: 'emerald',
            label: 'Emerald',
            description: 'Tailwind emerald. Its stop 600 is a mid green, light enough that white on a primary button drops under AA, which the contract below reports the moment you pick it.',
            values: [
        ...
        },
        {
            id: 'violet',
            label: 'Violet',
            description: 'Tailwind violet. Far enough from the Flux blue in hue to repaint the entire page and close enough in lightness that every role holds, though the dark button clears AA by less than a tenth: a scale can pass and still have nothing left to give.',
            values: [
        ...
        },
        {
            id: 'amber',
            label: 'Amber',
            description: 'Tailwind amber. The clearest failure of the set: stop 600 is a bright orange that white cannot sit on at any size, in a scale that otherwise looks perfectly usable.',
            values: [
        ...
        },
        {
            id: 'rose',
            label: 'Rose',
            description: 'Tailwind rose. Stop 600 clears AA by a hair, which is worth knowing before a redesign nudges the scale a shade lighter.',
            values: [

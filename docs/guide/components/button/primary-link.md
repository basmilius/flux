...
::: render
render=../../../code/guide/components/button/primary-link/preview.vue
:::
...
example=../../../code/guide/components/button/primary-link/basic.vue
:::

::: example Icon || A primary link button with an icon at the start or the end.
example=../../../code/guide/components/button/primary-link/icon.vue
:::

::: example Sizes || The primary link button is available in four sizes.
example=../../../code/guide/components/button/primary-link/sizes.vue
:::

...
::: render
render=../../../code/guide/components/button/destructive/preview.vue
:::
...
example=../../../code/guide/components/button/destructive/basic.vue
:::

::: example Icon || A destructive button with an icon at the start or the end.
example=../../../code/guide/components/button/destructive/icon.vue
:::

::: example Sizes || The destructive button is available in four sizes.
example=../../../code/guide/components/button/destructive/sizes.vue
:::

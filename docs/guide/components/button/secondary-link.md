...
::: render
render=../../../code/guide/components/button/secondary-link/preview.vue
:::
...
example=../../../code/guide/components/button/secondary-link/basic.vue
:::

::: example Icon || A secondary link button with an icon at the start or the end.
example=../../../code/guide/components/button/secondary-link/icon.vue
:::

::: example Sizes || The secondary link button is available in four sizes.
example=../../../code/guide/components/button/secondary-link/sizes.vue
:::

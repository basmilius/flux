...
::: render
render=../../../code/guide/components/menu/collapsible/preview.vue
:::
...
example=../../../code/guide/components/menu/collapsible/basic.vue
:::

::: example Navigate || A collapsible with a link on the header. Clicking navigates and opens.
example=../../../code/guide/components/menu/collapsible/navigate.vue
:::

::: example Controlled || Control the open state from outside with v-model:isOpened.
example=../../../code/guide/components/menu/collapsible/controlled.vue
:::
